  ...
  <div class="geser">
    <table clas="table table-dark table-borderless">
      ...
      <tbody>
        <tr>
          <th scope="row">
            <img src="wipi.jpg" class="card-img-top" alt="Toilet" width="230" height="130" />
          </th>
        ...
        <tr>
          <th scope="row">
            <img src="toilet.jpg" class="card-img-top" alt="Toilet" width="230" height="130" />
          </th>
          <td style="background-color: white; text-align: center;">
        ...
        <tr>
          <th scope="row">
            <img src="masjid.jpg" class="card-img-top" alt="Toilet" width="230" height="130" />
          </th>
          <td style="background-color: white; text-align: center;">
        ...
        <tr>
          <th scope="row">
            <img src="cctv.jpg" class="card-img-top" alt="Masjid" width="230" height="130" />
          </th>
          <td style="background-color: white; text-align: center;">
